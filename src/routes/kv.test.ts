...
import {kvGetHandler, kvPutHandler, validateKvGetRequest, validateKvPutRequest} from "./kv";
...
describe("kvPutHandler", () => {
    it("should set and return valid response", async () => {
        ...
        const req: KvPutRequest = {
            req: new Request("https://example.com/kv", {method: "PUT", body: JSON.stringify({key: "test", value: "test value"})}),
            method: "PUT",
            url: "https://example.com/kv",
            ctx,
            env,
    ...
    it("should throw validation error", async () => {
        ...
        await env.KV.put("test", "test value")
        const req: KvPutRequest = {
            req: new Request("https://example.com/kv", {method: "PUT", body: JSON.stringify({})}),
            method: "PUT",
            url: "https://example.com/kv",
            ctx,
            env,
